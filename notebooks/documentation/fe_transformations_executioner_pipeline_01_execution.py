...
# # Transformations Executioner Pipeline Execution
...
from src.constants.global_constants import FP
...
dfs_train_out_file, dfs_test_out_file = pipeline.execute(dfs_train=dfs, dfs_test=dfs, type_of_method=FP)
# -
