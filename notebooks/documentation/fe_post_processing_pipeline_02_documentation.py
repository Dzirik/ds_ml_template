...
from src.pipelines.post_processing_pipeline import PostProcessingPipeline
from src.pipelines.post_processing_pipeline_config_data import PostProcessingPipelineConfigData, PostProcessingOperation
# -
...
config_data = PostProcessingPipelineConfigData(
    name="my",
    post_processing_operations=[
        PostProcessingOperation(
            create=True,
            name_of_operation="remove_from_head",
            parameters={"n_of_rows": 10}
        ),
        PostProcessingOperation(
            create=True,
            name_of_operation="remove_from_tail",
            parameters={"n_of_rows": 1}
        )
    ]
)
config_data
