...
class PlotlyCandle(PlotlyTimeSeriesBase):  # type:ignore
    """
    ...
    def plot(self, df_market: DataFrame, series: Optional[List[Series]] = None, series_names: Optional[List[str]] \
            = None, series_obs_names: Optional[List[List[str]]] = None, events: Optional[List[Series]] = None, \
             event_names: Optional[List[str]] = None, event_obs_names: Optional[List[List[str]]] = None,
             vertical_lines_positions: Optional[List[float]] = None, plot_title: str = "Title", \
             y_title: str = "Y Axis Title", dashboard: bool = False) -> Optional[go.Figure]:
        """
